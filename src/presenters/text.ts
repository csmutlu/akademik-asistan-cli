...
export function renderHelpText(): string {
  ...
  return [
    ...
    '- Dogrudan komutlar: akademik-asistan gundem, akademik-asistan bugun, akademik-asistan duyurular',
    '- Hybrid TUI: akademik-asistan',
    '- Kisa alias: aa (shell cakismazsa)',
    '',
    'Baslangic:',
    ...
    'macOS sisteminde `aa` cakisabilir; guvenli komut: akademik-asistan',
...
export function renderOnboardingText(): string {
  return [
    ...
    '',
    'Interaktif mod: akademik-asistan',
    'Kisa alias: aa (shell cakismazsa)',
