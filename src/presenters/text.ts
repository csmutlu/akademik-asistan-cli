...
export function renderHelpText(): string {
  ...
  return ui([
    ...
    '- Terminal cihaz kodu verir, tarayıcı girişten sonra sizi doğrudan uygun Ayarlar > Terminal / CLI alanına taşır',
    '- Eski cli-auth bağlantıları da desteklenir, ama aktif web oturumunda doğrudan settings akışına yönlenir',
    '- akademik-asistan whoami',
    '- akademik-asistan buddy bugün neye odaklanayım',
    ...
    '- ?: yardım',
    '- r: yenile',
    '- otomatik arka plan yenileme: 15 sn',
...
export function renderOnboardingText(): string {
  ...
  return ui([
    ...
    '8. akademik-asistan buddy bugün neye odaklanayım',
    '',
